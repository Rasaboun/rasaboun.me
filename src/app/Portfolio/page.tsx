  ...
  return (
    <main className="flex flex-col space-y-20 items-center h-screen">
      <div className="py-2 px-6 bg-slate-100 rounded-xl my-5 mx-10 h-fit w-fit">
        <h1 className="  text-slate-800 text-3xl font-medium bg-[radial-gradient(ellipse_at_right,_var(--tw-gradient-stops))] from-slate-400 via-neutral-400 to-amber-500 text-transparent bg-clip-text drop-shadow-2xl">
